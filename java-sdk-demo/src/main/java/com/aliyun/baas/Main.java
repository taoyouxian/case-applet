...
public class Main {
    ...
    private static String executeChaincode(HFClient client, Channel channel) throws
...
//        executer.executeTransaction(client, channel, true,"set", "baas", newValue);
//        executer.executeTransaction(client, channel, false,"query", "baas");
//        String queryString = "{\"selector\":{\"idcard\":\"350802199505294512\"}}";
//        String queryString = "{\"selector\":{\"sharename\":\"赵然\"}}";
        String queryString = "\"15061126707\",\"江苏常州\",\"publickey\",\"流向\", \"男\", \"1995-05-26\", \"Tomoko\"";

        executer.executeTransaction(client, channel, true, "createUser", queryString);
        // executer.executeTransaction(client, channel, true,"createShareCase", "13713962176",  "15061126707", "2", "2018-3-29 10:20", "blue","Tomoko","Tomoko", "Tomoko");
        return executer.executeTransaction(client, channel, true, "createUser", queryString);
        //
    }
