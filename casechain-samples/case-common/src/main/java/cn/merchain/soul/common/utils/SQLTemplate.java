...
public class SQLTemplate {
    ...
    public static String selectCaseByParam(String phone, String hospital_number, String registration_number) {
        return String.format("select * from cases where phone = '%s' and hospital_number = '%s' and registration_number = '%s'  order by cid desc", phone, hospital_number, registration_number);
    }
}
